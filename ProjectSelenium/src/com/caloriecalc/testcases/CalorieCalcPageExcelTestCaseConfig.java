...
public class CalorieCalcPageExcelTestCaseConfig {
	//ChromeDriver driver;
	WebDriver driver;
	@BeforeMethod
	public void Initialize() throws IOException{
		System.out.println(PropertyReader.getProperty("browser"));
		if(PropertyReader.getProperty("browser").equals("chrome")){			
			System.setProperty(PropertyReader.getProperty("chromedriverproperty"),PropertyReader.getProperty("chromedriverpath"));		
	...
	public void CalorieCalcTestCaseMethod(Hashtable<String,String> caldata) throws InterruptedException, IOException{		
